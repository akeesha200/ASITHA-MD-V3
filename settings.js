...
SESSION_ID: process.env.SESSION_ID === undefined ? '𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=fv4V0IAJ#GOAeReeOgjMTiLFKE5FgW84MHqlsQB6-3QZKjk-kOBE' : process.env.SESSION_ID,
...
AUTO_REPLY: process.env.AUTO_REPLY === undefined ? "ture" : process.env.AUTO_REPLY,
...
WELCOME_GOODBYE: process.env.WELCOME_GOODBYE === undefined ? "ture" : process.env.WELCOME_GOODBYE,
ALLWAYS_OFFLINE: process.env.ALLWAYS_OFFLINE === undefined ? "ture" : process.env.ALLWAYS_OFFLINE,
...
AUTO_TIKTOK_SENDER: process.env.AUTO_TIKTOK_SENDER === undefined ? "ture" : process.env.AUTO_TIKTOK_SENDER,
...
BAD_NO_BLOCK: process.env.BAD_NO_BLOCK === undefined ? "ture" : process.env.BAD_NO_BLOCK,  
